...
System-prompt extraction detection. Once Phase-A is authorised and implemented the module will
...
- Future: see the Phase-A plan in the consuming HelixAgent repo at
  `docs/superpowers/specs/2026-04-21-elder-plinius-phaseA-go-cl4r1t4s.md`.
...
Original research corpus: `docs/research/go-elder-plinius-v3/go-elder-plinius/go-cl4r1t4s/`
...
This scaffold's `go.mod` declares the module as `digital.vasic.claritas` and
